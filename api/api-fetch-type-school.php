...
<?php
    ...
    $sql = "SELECT *,(SELECT COUNT(*) FROM schooltype JOIN schoolname ON schooltype.schooltypeId = schoolname.schooltype_id JOIN city ON schoolname.city_id=city.cityId) AS len FROM schooltype JOIN schoolname ON schooltype.schooltypeId = schoolname.schooltype_id JOIN city ON schoolname.city_id=city.cityId LIMIT $start,$limit";
