...
<?php
    //to update users collegestudents and schoolstudents............  
    require '_config.php';

    header('Content-Type: application/json'); // extra space ....................
    header('Access-Control-Allow-Origin: *');

    $schoolOrCollege = $_POST['edit-student-school-or-college'];
    ...
    if($schoolOrCollege == "college"){
        $userIdClg = $_POST['edit-college-student-user-id'];
        $emailClg = $_POST['edit-college-student-email'];
        $fnameClg = $_POST['edit-college-student-fname'];
        $lnameClg = $_POST['edit-college-student-lname'];
        $cityClg = $_POST['edit-college-student-city-select'];
        $universityNameClg = $_POST['edit-college-student-universityName-select'];
        $collegeNameClg = $_POST['edit-college-student-collegeName-select'];
        $studentIdClg = $_POST['edit-college-student-id'];
        $departmentClg = $_POST['edit-college-student-department-select'];
        $phoneNumberClg = $_POST['edit-college-student-phoneNumber'];
        $rollNo = $_POST['edit-college-student-rollNo'];
        $sem = $_POST['edit-college-student-sem'];
        ...
        try{
            ...
            $sqlForCollege2 ="UPDATE collegestudents SET branch='$departmentClg', phoneNumber='$phoneNumberClg',rollNumber=$rollNo,sem=$sem WHERE studentId=$studentIdClg" ;
    ...
    if($schoolOrCollege == "school"){
        $userIdSchl = $_POST['edit-school-student-user-id'];
        $emailSchl = $_POST['edit-school-student-email'];
        $fnameSchl = $_POST['edit-school-student-fname'];
        $lnameSchl = $_POST['edit-school-student-lname'];
        $citySchl = $_POST['edit-school-student-city-select'];
        $typeSchl = $_POST['edit-school-student-schoolType-select'];
        $schoolNameSchl = $_POST['edit-school-student-schoolName-select'];
        $studentIdSchl = $_POST['edit-school-student-id'];
        $classSchl = $_POST['edit-school-student-classAssigned-select'];
        $phoneNumberSchl = $_POST['edit-school-student-phoneNumber'];
        $rollNo = $_POST['edit-school-student-rollNo'];
        ...
        try{
            ...
            $sqlForSchool2 ="UPDATE schoolstudents SET standard='$classSchl', phoneNumber='$phoneNumberSchl',rollNumber=$rollNo WHERE studentId=$studentIdSchl" ;
