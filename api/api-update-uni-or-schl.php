...
<?php
    ...
    if(isset($_POST['edit-uni-universityName-select'])){
        $cityClg = $_POST['edit-uni-city-select'];
        $universityNameClg = $_POST['edit-uni-universityName-select'];
        $collegeNameClg = $_POST['edit-uni-collegeName-select'];
