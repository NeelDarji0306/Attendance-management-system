  ...
  <script>
    $(document).ready(function() {
                ...
                $(".info").html(
                  ...
                  ` 
                          ...
                          <div class="mx-auto mb-3 fs-4 fw-normal">${value.lastName}</div>
                            <div class="mx-auto fw-lighter fs-6">Roll Number</div>
                            <div class="mx-auto mb-3 fs-4 fw-normal">${value.rollNumber}</div>
                          <div class="mx-auto fw-lighter fs-6">Branch</div>
                          <div class="mx-auto mb-3 fs-4 fw-normal">${value.branch}</div>
                          <div class="mx-auto fw-lighter fs-6">Sem</div>
                          <div class="mx-auto mb-3 fs-4 fw-normal">${value.sem}</div>
              ...
              if ((value.university_id == undefined || value.university_id == null || value.university_id == "") && (value.college_id == undefined || value.college_id == null || value.college_id == "") &&
                ...
                $(".info").html(
                  ...
                  ` 
                            ...
                            <div class="mx-auto mb-3 fs-4 fw-normal">${value.standard}</div>
                            <div class="mx-auto fw-lighter fs-6">Email</div>
                            <div class="mx-auto mb-3 fs-4 fw-normal">${value.email}</div>
                            <div class="mx-auto fw-lighter fs-6">Contact Number</div>
                            <div class="mx-auto mb-3 fs-4 fw-normal">${value.phoneNumber}</div>
      ...
      $("#edit-btn").on("click", function(e) {
        e.preventDefault();
        window.location = "http://localhost/Attendance-system/student/update-profile.php";
      });
      ...
      $("#back-pp-btn").on("click", function(e) {
        e.preventDefault();
        // window.history.back();
        window.location = "http://localhost/Attendance-system/student/home.php";
      });
