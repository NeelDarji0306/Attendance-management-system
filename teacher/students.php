...
<body>
  ...
  <script>
    $(document).ready(function() {
      ...
      // const clgId = "<?php //echo $_SESSION['userInfo']['college_id'] ?>";
      // const schlId = "<?php //echo $_SESSION['userInfo']['schoolname_id'] ?>";
      let canDisplayStudents = false;
      sessionStorage.setItem("userId", uId);


      let teacherDetailsObj = {
        userId: uId,
        role: role,
        soc: soc
      ...
      function onLoad(){
        ...
        if(soc=="college"){
          ...
          $(".school-student-container").html("");
          $(".school-student-container").hide();

        } else{

          loadSchoolStudent(1);
          $(".college-student-container").html("");
          $(".college-student-container").hide();
        }
          // loadCollegeStudent(1);
          // loadSchoolStudent(1); 
      } 
      ...
      function loadSchoolStudent(page=1,limit=4){
        ...
        let jsonStrForPagination = JSON.stringify(jsonObjForPagination);
        $.ajax({
          url:"http://localhost/Attendance-system/api/api-fetch-school-user-teachers-module.php",
          type:"POST",
          data:jsonStrForPagination,
          async:false,
          success : function(data){
    ...
    // onLoad();
      ...
      // edit should be perform like this  AA NY CHALTU FOR SOME REASON IDK WHY ....... WE CAN REMOVE THOSE SELECTS FOR INSTANCE >.<
      // $(document).on("click",".edit-btn",function(){
      //   $("#modal").fadeIn();
      //   let that = this;
      //   let obj = {
      ...
      //                             <td> <strong>City</strong> </td>  
      //                             <td> 
      //                               <select name="edit-college-student-city-select" id="edit-college-student-city-select" disabled>
      //                                 <option value="select-city" disabled selected>---select city---</option>
      //                                 `+ loadCity("#edit-college-student-city-select",value.city_id) +`
      //                               </select> 
      //                             </td>  
      ...
      //                             <td> <strong>University</strong> </td>  
      //                             <td> 
      //                               <select name="edit-college-student-universityName-select" id="edit-college-student-universityName-select" disabled>
      //                                 <option value="select-university" disabled selected>---select university---</option>
      ...
      //                             <td> <strong>College</strong> </td>  
      //                             <td> 
      //                               <select name="edit-college-student-collegeName-select" id="edit-college-student-collegeName-select" disabled>
      //                                 <option value="select-college" disabled selected>---select college---</option>
      ...
      //                             <td> <strong>Branch</strong> </td>  
      //                             <td> 
      //                               <select name="edit-college-student-department-select" id="edit-college-student-department-select" disabled>
      //                                 <option value="select-branch" disabled selected>---select branch---</option>
      ...
      //                             <td> <strong>City</strong> </td>  
      //                             <td> 
      //                               <select name="edit-school-student-city-select" id="edit-school-student-city-select" disabled>
      //                                 <option value="select-city" disabled selected>---select city---</option>
      //                                 `+ loadCity("#edit-school-student-city-select",value.cityId) +`
      //                               </select> 
      //                             </td>  
      ...
      //                             <td> <strong>Type</strong> </td>  
      //                             <td> 
      //                               <select name="edit-school-student-schoolType-select" id="edit-school-student-schoolType-select" disabled>
      //                                 <option value="select-type" disabled selected>---select type---</option>
      ...
      //                             <td> <strong>School</strong> </td>  
      //                             <td> 
      //                               <select name="edit-school-student-schoolName-select" id="edit-school-student-schoolName-select" disabled>
      //                                 <option value="select-school" disabled selected>---select school---</option>
      ...
      //                             <td> <strong>Class</strong> </td>  
      //                             <td> 
      //                               <select name="edit-school-student-classAssigned-select" id="edit-school-student-classAssigned-select" disabled>
      //                                 <option value="select-classAssigned" disabled selected>---select class---</option>
      ...
      $("#add-college-student").on("click",function(){
        ...
        $("#add-form table").html(
                                ...
                                <tr>  
                                  ...
                                  <td> 
                                    <select name="city" id="city" disabled class"fw-bold">
                                      <option value="select-city" disabled selected>---select city---</option>
                                      `+ loadCity("#city",teacherDetailsObj.cityId) +`
                                    </select> 
                                  </td>  
                                </tr> 
                                <tr>  
                                ...
                                <tr>
                                  ...
                                  <td> 
                                    <select name="universityName" id="universityName" disabled class"fw-bold">
                                      <option value="select-university" disabled selected>---select university---</option>
                                      
                                      `+ loadUni("#universityName",teacherDetailsObj.cityId,teacherDetailsObj.uniId) +`
                                    </select>
                                  </td>  
                                </tr> 
                                <tr>   
                                  ...
                                  <td> 
                                    <select name="collegeName" id="collegeName" disabled class"fw-bold">
                                      <option value="select-college" disabled selected>---select college---</option>
                                      
                                      `+ loadClg("#collegeName",teacherDetailsObj.cityId,teacherDetailsObj.uniId,teacherDetailsObj.clgId) +`
                                    </select> 
                                  </td>  
                                </tr>  
                                <tr>   
                                  ...
                                  <td> 
                                    <select name="department" id="department" disabled class"fw-bold">
                                      <option value="select-branch" disabled selected>---select branch---</option>
                                      
                                      `+ loadDep("#department",teacherDetailsObj.branch) +`
                                    </select> 
                                  </td>  
                                </tr>  
      ...
      $("#add-school-student").on("click",function(){
        ...
        $("#add-form table").html(
                                ...
                                <tr>  
                                  <td> <strong><label for="city">City *</label></strong> </td>  
                                  <td> 
                                    <select name="city" id="city" disabled style="font-weight: normal;">
                                      <option value="select-city" disabled selected>---select city---</option>
                                      `+ loadCity("#city",teacherDetailsObj.cityId) +`
                                    </select> 
                                  </td>  
                                ...
                                <tr>
                                  ...
                                  <td> 
                                    <select name="schoolType" id="schoolType" disabled style="font-weight: normal;">
                                      <option value="select-type" disabled selected>---select type---</option>
                                      
                                      `+ loadSchlType("#schoolType",teacherDetailsObj.typeId) +`
                                    </select>
                                  </td>  
                                </tr> 
                                <tr>   
                                  ...
                                  <td> 
                                    <select name="schoolName" id="schoolName" disabled style="font-weight: normal;">
                                      <option value="select-school" disabled selected>---select school---</option>
                                      
                                      `+ loadSchlName("#schoolName",teacherDetailsObj.typeId,teacherDetailsObj.cityId,teacherDetailsObj.schlId) +`
                                    </select> 
                                  </td>  
                                </tr>  
                                <tr>   
                                  ...
                                  <td> 
                                    <select name="classAssigned" id="classAssigned" disabled style="font-weight: normal;">
                                      <option value="select-classAssigned" disabled selected>---select class---</option>
                                      
                                      `+ loadClass("#classAssigned",teacherDetailsObj.classAssigned) +`
                                    </select> 
                                  </td>  
                                </tr>  
      ...
      function searchSchoolStudent(search,page=1,limit=4){
        ...
        let jsonStrForPagination = JSON.stringify(jsonObjForPagination);
        $.ajax({
          url:"http://localhost/Attendance-system/api/api-search-school-user-teachers-module.php",
          type:"POST",
          data:jsonStrForPagination,
          success : function(data){
            $("#load-school-student").html("");
